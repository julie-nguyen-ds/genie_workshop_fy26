...
FROM main.thai_pc_insurance_workshop.policies p
JOIN main.thai_pc_insurance_workshop.agents a ON a.agent_id = p.agent_id
...
FROM main.thai_pc_insurance_workshop.claims cl
JOIN main.thai_pc_insurance_workshop.policies p ON p.policy_id = cl.policy_id
